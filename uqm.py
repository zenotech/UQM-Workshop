...
hornsrev_254p00_8p00pvd = PVDReader(FileName='/gpfs/projects/swept2/workarea/ARCHER/HORNSREV/hornsrev_254p00_8p00_P40_OUTPUT/hornsrev_254p00_8p00.pvd')
...
for i in range(20,100,10):
    ...
    # save screenshot
    SaveScreenshot('slice_'+str(i)+'.png')
